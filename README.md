...
> **New to code? Start with [`CHANGE_ME.md`](CHANGE_ME.md).**
> It tells you the **one file** to edit (`src/version.js`) and gives a simple
> 3-step exercise to run the whole pipeline — no coding knowledge needed.
...
```
devops-node-sample/
├── CHANGE_ME.md               # 👈 START HERE: the one file students edit
├── src/                       # the Node.js app
│   ├── version.js             # 👈 THE FILE STUDENTS EDIT
